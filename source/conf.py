# -*- coding: utf-8 -*-
#
# MARX documentation build configuration file, created by
# sphinx-quickstart on Thu Oct 23 12:03:46 2014.
#
...
project = u'MARX'
copyright = u'2002-2018, Massachusetts Institute of Technology'
...
# default values.
marxmarkup_marxparpath = os.path.abspath('../../dist/marx/par/marx.par')
...
# Primary domain for all documents.
primary_domain = 'std'
...
latex_documents = [
  ('index', 'MARX.tex', u'MARX Documentation',
   u'Hans Moritz Günther for the MARX team', 'manual')]
...
man_pages = [
    ('index', 'marx', u'MARX Documentation',
     [u'Hans Moritz Günther for the MARX team'], 1)
]
...
texinfo_documents = [
  ('index', 'MARX', u'MARX Documentation',
   u'Hans Moritz Günther', 'MARX', 'One line description of project.',
   'Miscellaneous'),
]
